...
<div class="row clearfix">
						...
						<c:if test="${cate.categoryID !=1  }">
							<li><span><i class="icon-minus-sign"></i>${cate.category }</span><a
								...
								onclick="onclickID('${cate.categoryID}');">&nbsp;&nbsp;<img
									title="操作" src="content/static/images/banshou.png"></a>
								<ul>
									<c:forEach var="cur" items="${cate.brands }" varStatus="vs">
										<li><span><i class="icon-minus-sign"></i>${cur.brandName }</span><a
											href="javascript:void(0);"
											onclick="onclickbrandID('${cate.categoryID }','${cur.brandID}');">&nbsp;&nbsp;<img
												title="操作" src="content/static/images/banshou.png"></a>
									</c:forEach>
								</ul></li>
						</c:if>
		...
		<div class="panel panel-default">
			...
			<div class="list-group-item">
				<p class="list-group-item-text">
					<br>
				<form class="form-horizontal" action="management/addBrand" id="form"
					name="IUpload" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="categoryID" name="categoryID"
								value="${shopCategory.categoryID }" type="hidden"> <input
								id="brandID" name="brandID" value="${brand.brandID }"
								type="hidden"> <input name="brandName"
								class="form-control" value="${brand.brandName }"> <br>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">
							logo照片</label>
						<div class="col-sm-8">
							<input name="sendFile" type="file" size="40" maxlength="40"
								class="form-control" onchange="PreviewImage(this);">
							图片大小&nbsp;&nbsp;<font color="red">120x70</font> <br>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-8" style="text-align: center;">
							...
							<button type="button" class="btn btn-default"
								onclick="updateDepartmen();">修改该品牌</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="btn btn-default"
								onclick="deleteDepartmen();">删除该品牌</button>
						</div>
					</div>
				</form>
				</P>
	...
	<script type="text/javascript">
		...
		function onclickbrandID(cateid, id) {
			location.href = "management/getBrandByCateID?cateID=" + cateid
					+ "&brandID=" + id;
		}
		...
		function deleteDepartmen() {
			location.href = "management/deleteBrand?categoryID="
					+ $('#categoryID').val() + "&brandID="
					+ $('#brandID').val();
		}
		$(function() {
